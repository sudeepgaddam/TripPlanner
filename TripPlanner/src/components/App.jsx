...
import TypedMessage from './Messages/TypedMessage.jsx'
...
class App extends Component{
	...
	componentWillMount(){
		...
		this.socket.on('messageTyping', this.onMessageTyping.bind(this));
	...
	onMessageAdded(message){
		...
		this.setState({typedMessage:{'user':'','text':''}})
	}
